                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="owner">By {{ $product->users->toko }}</div>
                            <div class="alamat">Lokasi : {{ $product->users->alamat }}</div>
                            <div class="stok">Stok : {{ number_format($product->stok) }}</div>
                        ...
                        <div class="col-lg-2" data-aos="zoom-in">
                            ...
                            @else
                                <a class="btn btn-success nav-link px-4 text-white btn-block mb-3"
                                    href="{{ route('login') }}">Login To Add</a>
                            @endauth
    ...
    <script>
        var gallery = new Vue({
            ...
            data: {
                activePhoto: 0,
                photos: [
                    @foreach ($product->gambar as $gallery)
                        {
                        id: {{ $gallery->id }},
                        url: "{{ Storage::url($gallery->gambar) }}",
                        },
                    @endforeach
                ],
            },
